                ...
                if(stud.getID() == studentID){
                    ...
                    while (true) {
                        ...
                        if (InputChecker.isFloat(tempString)) {
                            stud.setScore(Float.parseFloat(tempString));
                            break;
                        } else {
                            System.out.println("(!) Invalid input data");
                        }
                    ...
                    while (true) {
                        ...
                        tempString = input.nextLine();
                        if (tempString.length() != 0) {
                            stud.setDescription(tempString);
                            break;
                        } else {
                            System.out.println("(!) Invalid input data");
                        }
...
//            listStudent.add(createStudent(false));
            System.out.println("(i) Edit successful");
        } else {
    ...
    public static void deleteList() {
        ...
        // check and solve
        if (isIDExisted(studentID)) {
            listStudent.remove(studentID-1);
